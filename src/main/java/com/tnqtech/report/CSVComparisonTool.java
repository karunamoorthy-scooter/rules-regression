...
public class CSVComparisonTool {
    ...
    private static String getCSSStyles() {
        return "* { margin: 0; padding: 0; box-sizing: border-box; }\n" +
                ...
                ".data-table th { padding: 12px; text-align: left; font-weight: 600; color: #333; border-bottom: 2px solid #e0e0e0; }\n" +
                ".data-table td { padding: 12px; border-bottom: 1px solid #f0f0f0; word-break: break-word; }\n" +
