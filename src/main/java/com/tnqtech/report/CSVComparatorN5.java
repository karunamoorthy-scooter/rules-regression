...
import com.tnqtech.report.CSVComparatorN4.ComparisonResult;
import com.tnqtech.report.CSVComparatorN4.MatchedRule;
import com.tnqtech.report.CSVComparatorN4.MismatchedRule;


public class CSVComparatorN5 {
          ...
          //  String expectedFile = "1.Expected.csv";
           // String currentFile = "2.Current.csv";
			 ...
			 */
			 ...
			 String outputFile = "comparison_report_N4-10-1.html";
    ...
    private static void generateHTMLReport(ComparisonResult result, String outputFile) throws IOException {
        ...
        html.append("            --bs-text-opacity: 1;\n");
        html.append("            color: rgb(69 57 69) !important;\n");
        html.append("        }\n");
        ...
        html.append("            width: 100%;\n");
        html.append("            padding: 0.6rem;\n");
        html.append("            border: 1px solid #ddd;\n");
        html.append("            border-radius: 4px;\n");
        html.append("            font-size: 0.95rem;\n");
        html.append("        }\n");
        html.append("        .rows-per-page {\n");
        html.append("            display: flex;\n");
        html.append("            gap: 0.5rem;\n");
        html.append("            align-items: center;\n");
        html.append("        }\n");
        html.append("        .rows-per-page label {\n");
        html.append("            margin: 0;\n");
        html.append("            font-weight: 500;\n");
        html.append("        }\n");
        html.append("        .rows-per-page select {\n");
        ...
        html.append("            flex-wrap: wrap;\n");
        html.append("        }\n");
        html.append("        .pagination-controls button {\n");
        html.append("            padding: 0.5rem 0.8rem;\n");
        html.append("            border: 1px solid #ddd;\n");
        html.append("            background: white;\n");
        html.append("            border-radius: 4px;\n");
        ...
        html.append("        }\n");
        html.append("        .pagination-controls button:hover:not(:disabled) {\n");
        html.append("            background: #667eea;\n");
        html.append("            color: white;\n");
        html.append("            border-color: #667eea;\n");
        html.append("        }\n");
        html.append("        .pagination-controls button:disabled {\n");
        ...
        html.append("                filteredRows.slice(startIndex, endIndex).forEach(row => {\n");
        html.append("                    row.classList.remove('hidden-row');\n");
        html.append("                });\n");
        html.append("\n");
        ...
        html.append("                infoSpan.textContent = `Page ${currentPage} of ${totalPages} | Showing ${startRow}-${endRow} of ${filteredRows.length}`;\n");
        html.append("\n");
        html.append("                document.getElementById(tableId + 'PrevBtn').disabled = currentPage === 1;\n");
        ...
        html.append("                filteredRows = rows.filter(row => {\n");
        html.append("                    return row.textContent.toLowerCase().includes(searchTerm);\n");
        html.append("                });\n");
        html.append("                currentPage = 1;\n");
        html.append("                displayTable();\n");
        html.append("            }\n");
        html.append("\n");
        html.append("            rowsPerPageSelect.addEventListener('change', (e) => {\n");
        html.append("                rowsPerPage = parseInt(e.target.value);\n");
        html.append("                currentPage = 1;\n");
        html.append("                displayTable();\n");
        html.append("            });\n");
        html.append("\n");
        ...
        html.append("\n");
        html.append("            document.getElementById(tableId + 'PrevBtn').addEventListener('click', () => {\n");
        html.append("                if (currentPage > 1) {\n");
        html.append("                    currentPage--;\n");
        html.append("                    displayTable();\n");
        html.append("                }\n");
        html.append("            });\n");
        html.append("\n");
        html.append("            document.getElementById(tableId + 'NextBtn').addEventListener('click', () => {\n");
        html.append("                const totalPages = Math.ceil(filteredRows.length / rowsPerPage);\n");
        html.append("                if (currentPage < totalPages) {\n");
        html.append("                    currentPage++;\n");
        html.append("                    displayTable();\n");
        html.append("                }\n");
        html.append("            });\n");
        ...
        html.append("            initializePaginationAndSearch('matched');\n");
        html.append("            initializePaginationAndSearch('mismatched');\n");
        html.append("            initializePaginationAndSearch('missed');\n");
        html.append("            initializePaginationAndSearch('new');\n");
        html.append("        });\n");
        html.append("    </script>\n");
        html.append("</body>\n");
        html.append("</html>\n");
